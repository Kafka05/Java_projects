...
public class ClubManagmentSystem {
	...
	public void welcomePage() {
		...
		wp.welcomeMsg.setForeground(Color.white);
...
//Add an action listener to the button
		ald.backButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				wp.setVisible(true);
				ald.frame.setVisible(false);
	...
	public void viewAdminPanel() {
		...
		ap.backButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				ald.frame.setVisible(true);
				ap.setVisible(false);
		...
		//Add an action listener to the button
				nd.backButton.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {
						ap.setVisible(true);
						nd.setVisible(false);
				...
				ad.backButton.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {
						ap.setVisible(true);
						ad.setVisible(false);
...
//Add an action listener to the button
	...
	public void addAMember() {
		...
		//Add an action listener to the button
				am.backButton.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {
						am.setVisible(false);
						cm.setVisible(true);
	...
	public void removeAMember() {
		...
		//Add an action listener to the button
		rm.backButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				rm.setVisible(false);
				cm.setVisible(true);
	...
	public void approvePendingReqs() {
		...
		//Add an action listener to the button
				apr.backButton.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {
	...
	public void searchForMember() {
		...
		//Add an action listener to the button
		sfm.backButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
	...
	public void userLogin() throws Exception {
					...
					if (HelperMethod.isValidId(input)) {
						while (i != null) {
							if (input.equals(i)) {
								...
								//Add an action listener to the button
								up.backButton.addActionListener(new ActionListener() {
									public void actionPerformed(ActionEvent e) {
										up.setVisible(false);
										wp.setVisible(true);
		...
		//Add an action listener to the button
		uld.backButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				uld.setVisible(false);
				wp.setVisible(true);
	...
	public void joinAsAMember() {
		try {
			...
			//Add an action listener to the button
			jam.backButton.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					jam.setVisible(false);
					up.setVisible(true);
